...
-- Module  Version: 5.7
--C:\lscc\diamond\3.9_x64\ispfpga\bin\nt64\scuba.exe -w -n xo3lstarter_clkgen_50_12 -lang vhdl -synth synplify -arch xo3c00a -type pll -fin 12 -fclkop 48 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 -lock 
...
entity xo3lstarter_clkgen_50_12 is
    port (
        CLKI: in  std_logic; 
        CLKOP: out  std_logic; 
        LOCK: out  std_logic);
end xo3lstarter_clkgen_50_12;

architecture Structure of xo3lstarter_clkgen_50_12 is
...
-- synopsys translate_off
library MACHXO3L;
configuration Structure_CON of xo3lstarter_clkgen_50_12 is
    for Structure
